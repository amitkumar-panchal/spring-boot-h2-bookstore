...
insert into tbluser (username, password, name) values ('cashier1','test', 'Cashier - 1');
insert into tbluser (username, password, name) values ('cashier2','1234', 'Cashier - 2');
insert into tbluser (username, password, name) values ('manager','abcd', 'Manager - 1');
insert into tbluser (username, password, name) values ('admin','admin', 'Administrator');


insert into tblrole (username, role) values ('cashier1', 'Cashier');
insert into tblrole (username, role) values ('cashier2','Cashier');
insert into tblrole (username, role) values ('manager','Manager');
insert into tblrole (username, role) values ('admin','manager-script');
